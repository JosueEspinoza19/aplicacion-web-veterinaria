...
// Inicializar errores y valores de campos
$errores = ['nombre' => '', 'telefono' => ''];
$nombre = $dueno['nombre'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores['nombre']) && empty($errores['telefono'])) {
        $conn->query("UPDATE duenos SET nombre='$nombre', telefono='$telefono' WHERE id=$id");
...
<h1 id="texto_principal">Editar Dueño</h1>
